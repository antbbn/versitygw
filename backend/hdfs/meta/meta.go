...
// Same as meta.MetadataStorer execpt the first argument is a full path.
type MetadataStorer interface {
	...
	RetrieveAttribute(fullpath, bucket, object, attribute string) ([]byte, error)
	...
	StoreAttribute(fullpath, bucket, object, attribute string, value []byte) error
